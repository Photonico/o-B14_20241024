...
ax1.plot(Bands.get("kpoint_distances"),Bands.get("bands_up"), color="orange", label="spin up")
ax1.plot(Bands.get("kpoint_distances"),Bands.get("bands_down"), color="red", linestyle="--", label="spin down")
...
plt.tight_layout()
#plt.show()
plt.savefig("oB14_monolayer_bandstructure.pdf",dpi=600)